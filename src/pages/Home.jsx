    ...
    <main className="home">
      <form className="home__form" onSubmit={handleSubmit}>
        <div className="home__contain">
          <input className="home__input" id="nameProduct" type="text" placeholder="Search a product" />
        ...
        <div className="home__category">
          <h3 className="home__category-title">Categories</h3>
          <ul className="home__list">
            <li className="home__list-texts" onClick={() => setCategoryFilter(0)}>All</li>
            {categories.map((category) => (
              <li className="home__list-texts" onClick={() => setCategoryFilter(category.id)} key={category.id}>{category.name}</li>
            ))}
          </ul>
        </div>
      </form>
